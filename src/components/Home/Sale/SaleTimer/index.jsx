          ...
          <div className="sale__content">
            <div className="sale__block">
              ...
              <p className="sale__text text-muted">
                The most wanted styles is waiting for you right now. Find the
                best styles of modern outfits for you at one place.
              </p>
            </div>
            ...
            <div className="sale__button button-wrapper">
              <a className="button button_lg button_default" href="#">
                buy now<span className="icon-arrow"></span>
              </a>
            </div>
          </div>
        </div>
