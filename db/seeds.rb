...
#
# ActiveRecord::Base.connection.execute "INSERT INTO products (producer_id, category_id, name, description, price, gender_id, main_photo_id) VALUES (1, 1, 'Nike Shoes 1', 'Description for Product', 100,     1,    1);"
# ActiveRecord::Base.connection.execute "INSERT INTO products (producer_id, category_id, name, description, price, gender_id, main_photo_id) VALUES (1, 1, 'Nike Shoes 2', 'Description for Product', 100,     1,    2);"
# ActiveRecord::Base.connection.execute "INSERT INTO products (producer_id, category_id, name, description, price, gender_id, main_photo_id) VALUES (2, 2, 'Adidas t-shirt 1', 'Description for Product', 100, 2,    3);"
# ActiveRecord::Base.connection.execute "INSERT INTO products (producer_id, category_id, name, description, price, gender_id, main_photo_id) VALUES (2, 1, 'Adidas shoes 1', 'Description for Product', 100,   2,    4);"
# ActiveRecord::Base.connection.execute "INSERT INTO products (producer_id, category_id, name, description, price, gender_id, main_photo_id) VALUES (3, 1, 'Puma shoes 1', 'Description for Product', 100,     3,    5);"
# ActiveRecord::Base.connection.execute "INSERT INTO products (producer_id, category_id, name, description, price, gender_id, main_photo_id) VALUES (3, 1, 'Puma shoes 2', 'Description for Product', 100,     4,    6);"
# ActiveRecord::Base.connection.execute "INSERT INTO products (producer_id, category_id, name, description, price, gender_id, main_photo_id) VALUES (4, 2, 'Reebok t-shirt 1', 'Description for Product', 100, 4,    7);"
#
...
# users = User.all
#
# # Додавання фото для кожного користувача
# users.each do |user|
#   # Завантаження аватара для кожного користувача
#   user.avatar.attach(io: File.open('C:\Users\User\Desktop\photo_2024-05-15_13-11-30.jpg'), filename: 'avatar.jpg', content_type: 'image/jpeg')
# end
...
products.each do |product|
  # Завантаження аватара для кожного користувача
  product.avatar.attach(io: File.open('C:\Users\User\Desktop\photo_2024-05-15_13-11-30.jpg'), filename: 'avatar.jpg', content_type: 'image/jpeg')
end